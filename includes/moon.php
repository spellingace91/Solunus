...
class Moon {
	...
	/**
	 * Calculates the moon rise for a given location and day of year
	 */
	public static function calculateMoonRise($month, $day, $year, $lat, $lon, $dst) {
		...
		return date('g:i a', $set ? mktime($utrise['hrs'] + $dst, $utrise['min'], 0, $month, $day, $year) : mktime(0, 0, 0, $month, $day + 1, $year));
	
	}
	
	/**
	 * Calculates the moon set for a given location and day of year
	 */
	public static function calculateMoonSet($month, $day, $year, $lat, $lon, $dst) {
		...
		$utrise = self::convertTime($utrise);
		$utset = self::convertTime($utset);
		return date('g:i a', $set ? mktime($utset['hrs'] + $dst, $utset['min'], 0, $month, $day, $year) : mktime(0, 0, 0, $month, $day + 1, $year));
